...
<header>
        ...
        <li class="<?php if($page == 'locaux.php' || $page == 'materiaux.php' || $page == 'services.php' || $page == 'personnels.php' || $page == 'statut.php' ){ echo ' active"';}?>"><a href="locaux.php">Presentation</a></li>
